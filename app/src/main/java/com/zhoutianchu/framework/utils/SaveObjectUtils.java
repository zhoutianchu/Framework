...
public class SaveObjectUtils {
    ...
    private String name;
    private static SaveObjectUtils instance;

    private SaveObjectUtils(Context context) {
        this.context = context;
        this.name = context.getPackageName();
    }

    public static SaveObjectUtils getInstance(Context context) {
        if (instance == null) {
            instance = new SaveObjectUtils(context);
        }
        return instance;
    }
