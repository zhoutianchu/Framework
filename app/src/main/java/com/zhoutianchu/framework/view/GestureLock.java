...
public class GestureLock extends ViewGroup {
    ...
    public interface OnGestureEventListener {
        ...
        void getGestureResult(int[] result);
    }
    ...
    private void updateParametersForAdapter() {
        ...
        if (defaultGestures.length > negativeGestures.length)
            throw new IllegalArgumentException("defaultGestures length must be less than or equal to " + negativeGestures.length);
            ...
            switch (event.getActionMasked()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (gesturesContainer[0] != -1) {
                        ...
                        if (onGestureEventListener != null) {
                            onGestureEventListener.getGestureResult(gesturesContainer);
