...
public class CircleImageTransform extends BitmapTransformation {
    private static String ID = "com.zhoutianchu.framework.view.CircleImageTransform";
    private static byte[] ID_BYTES = new byte[1];
    ...
    public boolean equals(Object o) {
        return o instanceof CircleImageTransform;
    }
